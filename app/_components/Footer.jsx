  ...
  <div className="mx-auto max-w-screen-xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
    <div className="sm:flex sm:items-center sm:justify-between">
      <div className="text-white">
        <h2 className='text-2xl font-semibold uppercase'>Attendance Monitoring</h2>
      </div>

      <ul className="mt-8 flex justify-start gap-6 sm:mt-0 sm:justify-end">
        <li>
          <a
            href="https://www.facebook.com/manav.parmar.108"
            rel="noreferrer"
            target="_blank"
        ...
        <li>
          <a
            href="https://www.instagram.com/manavparmar004/"
            rel="noreferrer"
            target="_blank"
            className="text-white transition hover:opacity-75"
          >
        ...
        <li>
          <a
            href="https://x.com/parmar_man63487"
            rel="noreferrer"
            target="_blank"
            className="text-white transition hover:opacity-75"
          >
        ...
        <li>
          <a
            href="https://github.com/manavparmar044"
            rel="noreferrer"
            target="_blank"
            className="text-white transition hover:opacity-75"
          >
    ...
    >
      ...
      <div>
        ...
        <ul className="mt-6 space-y-4 text-sm">
          ...
          <li>
            <a href="https://www.linkedin.com/in/manav-manish-parmar-129869208/" className="text-white transition hover:opacity-75"> Meet the Developer </a>
          </li>
      ...
      <div>
        ...
        <ul className="mt-6 space-y-4 text-sm">
          <li>
            <a href="https://www.linkedin.com/in/manav-manish-parmar-129869208/" className="text-white transition hover:opacity-75"> Contact </a>
          </li>
    ...
    <p className="text-xs text-gray-50">&copy; 2024. Manav Manish Parmar. All rights reserved.</p>
    <p></p>
    </div>
  </div>
</footer>
